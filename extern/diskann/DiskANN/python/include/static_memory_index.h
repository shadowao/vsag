...
{
  public:
    StaticMemoryIndex(diskann::Metric m, const std::string &index_prefix, uint64_t num_points,
                     uint64_t dimensions, uint32_t num_threads, uint32_t initial_search_complexity);
